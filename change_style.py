...
Original file is located at
    https://colab.research.google.com/drive/1pBjXDbFMj_1Mha2pvEfgRUqJqPTb_C79
"""
...
def main():
    ...
    content_img = Image.open("input.jpeg")
    style_img = Image.open("shuilian.jpeg")
    ...
    output = train(content_X, net,  content_Y, styles_Y, content_layers, style_layers, device, 0.3, 3000, 50)
